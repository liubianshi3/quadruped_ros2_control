...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "locomotion_acceptance = dog2_bringup.locomotion_acceptance:main",
            "locomotion_acceptance_batch = dog2_bringup.locomotion_acceptance_batch:main",
            "locomotion_acceptance_calibrate = dog2_bringup.locomotion_acceptance_calibrate:main",
