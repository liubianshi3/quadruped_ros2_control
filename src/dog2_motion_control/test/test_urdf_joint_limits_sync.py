...
def test_leg_parameters_limits_match_urdf():
    urdf_limits = load_dog2_urdf_joint_limits("real")
...
def test_symmetric_leg_parameters_limits_match_symmetric_urdf():
    urdf_limits = load_dog2_urdf_joint_limits("symmetric")
    assert urdf_limits.source_path.endswith("dog2_symmetric.urdf.xacro")
